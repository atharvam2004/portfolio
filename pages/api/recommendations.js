...
const recommendationCard = [
  {
    ...
    designation:
      "REACTJS | POSTGRESQL | NODE | EXPRESS | PRISMA ORM | SCSS | ANTD",
    view1:
  ...
  },
  {
    ...
    view4:
      "• Used Node.js to create a robust backend for efficient data processing.",
  ...
  },
  {
    ...
    view3:
      "• Carefully crafted the layout and interactions in Figma to achieve a visually appealing and intuitive interface.",
    linkednURL: "https://atharvasportfolio.netlify.app/",
  },

  {
    ...
    view3:
      "• Ensured optimal user experience with a responsive design on various devices.",
    view4:
      "• Incorporated MailJS API to enable effective communication with clients and streamline email interactions for inquiries and updates.",
